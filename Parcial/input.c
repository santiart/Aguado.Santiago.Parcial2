...
{
        printf("///////////////BIENVENIDOS////////////////\n\n");
        printf("\n1.Cargar los datos de los dominios desde el archivo AutosCarrera.csv\n");
        printf("2.Mapear tiempos\n");
        printf("3.Guardar listas mapeadas en el archivo AutosCarrera.csv\n");
        printf("4.Salir\n");
}
